...
export var Wrapper_ManualPage = (function () {
    function Wrapper_ManualPage(p0) {
        this.changed = false;
        this.context = new import0.ManualPage(p0);
    }
    Wrapper_ManualPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_ManualPage;
}());
var renderType_ManualPage_Host = null;
var _View_ManualPage_Host0 = (function (_super) {
    __extends(_View_ManualPage_Host0, _super);
    function _View_ManualPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_ManualPage_Host0, renderType_ManualPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_ManualPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-manual', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_ManualPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._ManualPage_0_4 = new Wrapper_ManualPage(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._ManualPage_0_4.context, [], compView_0);
        compView_0.create(this._ManualPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_ManualPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.ManualPage) && (0 === requestNodeIndex))) {
            return this._ManualPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_ManualPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._ManualPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_ManualPage_Host0;
}(import1.AppView));
function viewFactory_ManualPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ManualPage_Host === null)) {
        (renderType_ManualPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_ManualPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var ManualPageNgFactory = new import10.ComponentFactory('page-manual', viewFactory_ManualPage_Host0, import0.ManualPage);
var styles_ManualPage = [];
var renderType_ManualPage = null;
var _View_ManualPage0 = (function (_super) {
    __extends(_View_ManualPage0, _super);
    function _View_ManualPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_ManualPage0, renderType_ManualPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_ManualPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, '使用手册', null);
    ...
    _View_ManualPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_ManualPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_ManualPage0.prototype.destroyInternal = function () {
        this._Content_10_4.context.ngOnDestroy();
    };
    return _View_ManualPage0;
}(import1.AppView));
export function viewFactory_ManualPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ManualPage === null)) {
        (renderType_ManualPage = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_ManualPage, {}));
    }
    return new _View_ManualPage0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=manual.ngfactory.js.map